	  ...
	  _createClass(ParticipantsContainer, [{
	    ...
	    value: function connect() {
	      ...
	      if (false) {
	        ...
	        console.log('hello');
	        var perm = this.props.permissions.findIndex(function (permission) {
	          console.log(permission.user_id, _this2.props.loggedInUser.id);
	          return permission.user_id = 1000;
	        });
	        console.log('TRUE OR FALSE', perm);
...
//# sourceMappingURL=0.7b870a9f4202cba77974.hot-update.js.map