...
/***/ function(module, exports, __webpack_require__) {
	...
	function onBoardEnter(nextRouterState) {
	  ...
	  if (!_store2.default.getState().noteReducer.all.length) {
	    _store2.default.dispatch((0, _note.getAllNotes)({ boardUrl: boardUrl }));
	  }
	}
	...
	function Routes() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_reactRouter.Route, { path: '/boards/:boardUrl', component: _BoardContainer2.default, onEnter: onBoardEnter }),
	      _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/note' },
...
//# sourceMappingURL=0.8436c470422b46af8d5f.hot-update.js.map