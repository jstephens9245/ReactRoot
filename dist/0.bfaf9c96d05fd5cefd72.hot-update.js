	    ...
	    _react2.default.createElement(
	      ...
	      !!boards.length && boards.map(function (board) {
	        if (filterArr.indexOf(board.id) !== -1) {
	          return _react2.default.createElement(
	            'div',
	            { className: '', key: board.id },
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { className: 'thumbnail', style: { display: 'inline-block', overflow: 'hidden' }, to: '/boards/' + board.hash },
...
//# sourceMappingURL=0.bfaf9c96d05fd5cefd72.hot-update.js.map