	    ...
	    value: function boardUpdate(note) {
	      if (note.board_id === this.props.board.id) {
	        do {
	          ...
	          this.props.removeListener('note');
	        } while (false);{}
	      }
	    }
	  }, {
...
//# sourceMappingURL=0.78dbf9c64ff183de09cd.hot-update.js.map