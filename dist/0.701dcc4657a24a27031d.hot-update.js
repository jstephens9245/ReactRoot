	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	  return {
	    onBoardEnter: function onBoardEnter() {
	      var string = ownProps.location.pathname;
	      console.log(string);
	      var boardId = string[string.length - 1];
	      dispatch((0, _board.getBoard)(boardId));
	      dispatch((0, _note.getAllNotes)({ boardId: boardId }));
	    }
	  };
	};
...
//# sourceMappingURL=0.701dcc4657a24a27031d.hot-update.js.map