...
/***/ function(module, exports, __webpack_require__) {
	...
	var addUserPermission = exports.addUserPermission = function addUserPermission(userId, board) {
	  return function (dispatch) {
	    return _axios2.default.put('/api/boards/', { userId: userId, board: board }).then(function (res) {
	      return res.data;
	    }).then(function (boards) {
	      dispatch(receiveNewPermission(boards.boards, boards.permissions));
	    });
	  };
	};
	...
	var createBoard = exports.createBoard = function createBoard(boardName) {
	  return function (dispatch) {
	    return _axios2.default.post('/api/boards/permissions', { boardName: boardName }).then(function (res) {
	      return res.data;
	    }).then(function (board) {
...
//# sourceMappingURL=0.460023af71402f334163.hot-update.js.map