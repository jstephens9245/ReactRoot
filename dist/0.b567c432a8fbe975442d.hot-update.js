...
/***/ function(module, exports, __webpack_require__) {
	...
	var NB = function (_Component) {
	  ...
	  function NB(props) {
	    ...
	    _this.state = {
	      aria: false,
	      toggleClass: 'navClass navbar-collapse collapse in'
	    };
	  ...
	  _createClass(NB, [{
	    ...
	    value: function expandNav() {
	      ...
	      if (this.state.toggleClass === 'navClass navbar-collapse collapse in') {
	        newToggleClassValue = 'navClass navbar-collapse collapse in navToggle';
	      } else {
	        newToggleClassValue = 'navClass navbar-collapse collapse in';
	      }
	      this.setState({
...
//# sourceMappingURL=0.b567c432a8fbe975442d.hot-update.js.map