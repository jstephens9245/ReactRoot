...
/***/ function(module, exports) {
	...
	var CHANGE_NOTE_SIZE = exports.CHANGE_NOTE_SIZE = 'CHANGE_NOTE_SIZE';
	...
	var SET_NOTES_SIZE = exports.SET_NOTES_SIZE = 'SET_NOTES_SIZE';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    ...
	    case _constants.RECEIVE_PERMISSION:
	      newState.permissions = [].concat(_toConsumableArray(newState.permissions), [action.permission]);
	      break;
	    case _constants.SET_NOTES_SIZE:
	...
	var initialState = { selectedBoard: {}, allBoards: [], selectedBoardNotes: [], permissions: [], notesSize: 0 };
	  ...
	  _createClass(BoardContainer, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ParticipantsContainer2.default, { board: this.props.board })
	      );
	    }
	  }]);
	  ...
	  _createClass(CustomDragLayerContainer, [{
	    ...
	    value: function render() {
	      ...
	      var _props2 = this.props,
	          board = _props2.board,
	          notesSize = _props2.notesSize;
	
	
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_NoteBoardContainer2.default, { snapToGrid: snapToGridAfterDrop, board: board, showNoteComments: this.props.showNoteComments, notesSize: notesSize }),
	        _react2.default.createElement(_CustomDragLayer2.default, { snapToGrid: snapToGridWhileDragging, board: board, notesSize: notesSize }),
	        _react2.default.createElement(
	          'div',
	          { className: 'snapTo' },
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteBoardContainer = function (_Component) {
	  ...
	  _createClass(NoteBoardContainer, [{
	    ...
	    key: 'renderNote',
	    value: function renderNote(item, key, notesSize) {
	      return _react2.default.createElement(
	        _DraggableNote2.default,
	        _extends({ key: key, id: key }, item, { showNoteComments: this.props.showNoteComments, size: notesSize }),
	        item.content
	      );
	    }
	  }, {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            notes.map(function (note) {
	              return _this2.renderNote(note, note.id, notesSize);
	            })
	          )
	        ),
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var noteSource = {
	  beginDrag: function beginDrag(props) {
	    ...
	    return { id: id, left: left, top: top, content: content, color: color, size: size };
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CustomDragLayer = function (_Component) {
	  ...
	  _createClass(CustomDragLayer, [{
	    key: 'renderItem',
	    value: function renderItem(type, item, size) {
	
	      switch (type) {
	        case _constants.NOTE:
	          return _react2.default.createElement(_NoteDragPreview2.default, { content: item.content, color: item.color, size: size });
	        default:
	          return null;
	      }
	    }
	  ...
	  _createClass(NoteDragPreview, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { style: styles },
	        _react2.default.createElement(_NoteWrapper2.default, { noteRaised: true, red: tickTock, content: content, color: color, size: size })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(_SizeSliderContainer2.default, null)
	      )
	    )
	  );
	};
	...
	var _SizeSliderContainer = __webpack_require__(/*! ../containers/SizeSliderContainer */ 785);
	
	var _SizeSliderContainer2 = _interopRequireDefault(_SizeSliderContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setNotesSize = exports.setNotesSize = function setNotesSize(size) {
	  return {
	    type: _constants.SET_NOTES_SIZE,
	    notesSize: size
	  };
	};
...
/***/ 785:
/*!**************************************************!*\
  !*** ./client/containers/SizeSliderContainer.js ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var SizeSliderContainer = function (_Component) {
	  _inherits(SizeSliderContainer, _Component);
	
	  function SizeSliderContainer(props) {
	    _classCallCheck(this, SizeSliderContainer);
	
	    var _this = _possibleConstructorReturn(this, (SizeSliderContainer.__proto__ || Object.getPrototypeOf(SizeSliderContainer)).call(this, props));
	  ...
	  _createClass(SizeSliderContainer, [{
	    ...
	    value: function handleSliderChange(e) {
	      ...
	      _store2.default.dispatch((0, _board.changeNoteSize)(this.state.size, this.props.board));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { id: 'slider', type: 'range', min: '50', max: '300', step: '25', value: this.state.size,
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ changeNoteSize: _board.changeNoteSize }, dispatch);
	};
	
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(SizeSliderContainer);

/***/ }

})
//# sourceMappingURL=0.3a9d4607b517a0167a40.hot-update.js.map