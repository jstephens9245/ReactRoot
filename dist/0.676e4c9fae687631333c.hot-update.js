...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navbar = function Navbar(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'navbar navbar-fixed-top navbar', role: 'navigation' },
	    _react2.default.createElement(
	      'div',
	      { className: 'container' },
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { type: 'button', className: 'navbar-toggle', 'data-toggle': 'collapse', 'data-target': '#nav-items' },
	          _react2.default.createElement(
	            'span',
	            { className: 'sr-only' },
	            'Toggle navigation'
	        ...
	        _react2.default.createElement(
	          'a',
	          { className: 'navbar-brand navbar-brand-red', href: '/' },
	          'Notion'
	        )
	      ),
	      _react2.default.createElement(
	        'div',
	        { id: 'nav-items', className: 'collapse navbar-collapse' },
	        _react2.default.createElement(
	          'ul',
...
//# sourceMappingURL=0.676e4c9fae687631333c.hot-update.js.map