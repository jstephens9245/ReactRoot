...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      if (false) {
	        ...
	        if (Object.keys(this.props.loggedInUser).length) {
	          if (this.props.permissions.findIndex(function (permission) {
	            ...
	            this.props.userPermission(this.props.selectedBoard.id);
	          }
	        }
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    ...
	    userPermission: function userPermission(boardId) {
	      dispatch((0, _board.addUserPermission)(boardId));
	    }
	  };
	};
...
//# sourceMappingURL=0.f6533a5ff16ce76690bc.hot-update.js.map