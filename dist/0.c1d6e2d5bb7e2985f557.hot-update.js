...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.receivemyBoardsPageNotes = receivemyBoardsPageNotes;
	exports.selectNote = selectNote;
	exports.getNote = getNote;
	exports.getAllNotes = getAllNotes;
	exports.getAllMyBoardNotes = getAllMyBoardNotes;
	...
	function receivemyBoardsPageNotes(notes, boardId) {
	  return {
	    type: _constants.RECEIVE_MYBOARDS_NOTES,
	    notes: notes,
	    boardId: boardId
	  };
	}
	...
	function getAllMyBoardNotes(_ref4) {
	  ...
	  return function (dispatch) {
	    return _axios2.default.get('/api/notes/', { params: { userId: userId, boardId: boardId } }).then(function (res) {
	      ...
	      return dispatch(receivemyBoardsPageNotes(notes, boardId));
	    }).catch(function (err) {
	      return console.warn(err);
	    });
	  };
...
//# sourceMappingURL=0.c1d6e2d5bb7e2985f557.hot-update.js.map