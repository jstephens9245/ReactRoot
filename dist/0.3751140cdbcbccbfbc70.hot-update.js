...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      return (
	        ...
	        _react2.default.createElement(
	          ...
	          { style: {
	              ...
	              height: 1000,
	              position: 'relative' } },
	          this.props.notes ? this.props.notes[this.props.board.id].map(function (note) {
	            var left = note.left,
	                top = note.top;
	...
	var mapStateToProps = function mapStateToProps(state, ownProps) {
	  console.log(state.noteReducer.allBoardSpecificNotes[ownProps.board.id]);
	  return {
	    notes: state.noteReducer.allBoardSpecificNotes[ownProps.board.id],
...
//# sourceMappingURL=0.3751140cdbcbccbfbc70.hot-update.js.map